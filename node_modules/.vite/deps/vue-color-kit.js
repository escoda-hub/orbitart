...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", {
    ...
    createVNode("canvas", _hoisted_1, null, 512),
    createVNode("div", {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", {
    ...
    createVNode("canvas", _hoisted_1$2, null, 512),
    createVNode("div", {
...
var script$4 = defineComponent({
  ...
  methods: {
    ...
    mousemoveHandler(e) {
      ...
      if (this.suckerArea.length && clientX >= this.suckerArea[0] && clientY >= this.suckerArea[1] && clientX <= this.suckerArea[2] && clientY <= this.suckerArea[3]) {
        style.display = "";
      } else {
        style.display = "none";
      }
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", null, [
    !_ctx.isSucking ? (openBlock(), createBlock("svg", {
      key: 0,
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", _hoisted_1$4, [
    createVNode("span", _hoisted_2$1, toDisplayString(_ctx.name), 1),
